    ...
    public partial class DataSetKH : global::System.Data.DataSet {
        ...
        public partial class KhachhangDataTable : global::System.Data.TypedTableBase<KhachhangRow> {
            ...
            private void InitClass() {
                ...
                this.columnThanhPho.MaxLength = 2;
...
namespace QuanLyBanHang.QuanLyBanHangDataSetTableAdapters {
    ...
    public partial class KhachhangTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Khachhang] WHERE (([MaKH] = @Original_MaKH) AND ([TenCty] = @Original_TenCty) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ([ThanhPho] = @Original_ThanhPho) AND ((@IsNull_DienThoai = 1 AND [DienThoai] IS NULL) OR ([DienThoai] = @Original_DienThoai)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Khachhang] SET [MaKH] = @MaKH, [TenCty] = @TenCty, [DiaChi] = @DiaChi, [ThanhPho] = @ThanhPho, [DienThoai] = @DienThoai WHERE (([MaKH] = @Original_MaKH) AND ([TenCty] = @Original_TenCty) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ([ThanhPho] = @Original_ThanhPho) AND ((@IsNull_DienThoai = 1 AND [DienThoai] IS NULL) OR ([DienThoai] = @Original_DienThoai)));
