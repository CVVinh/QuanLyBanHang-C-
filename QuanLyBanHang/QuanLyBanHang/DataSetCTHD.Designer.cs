...
namespace QuanLyBanHang {
    ...
    public partial class DataSetCTHD : global::System.Data.DataSet {
        ...
        public partial class SanPhamDataTable : global::System.Data.TypedTableBase<SanPhamRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public SanPhamRow AddSanPhamRow(string MaSP, string TenSP, string DonViTinh, double DonGia, string Hinh) {
...
namespace QuanLyBanHang.DataSetCTHDTableAdapters {
    ...
    public partial class SanPhamTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[SanPham] WHERE (([MaSP] = @Original_MaSP) AND ([TenSP] = @Orig" +
                "inal_TenSP) AND ((@IsNull_DonViTinh = 1 AND [DonViTinh] IS NULL) OR ([DonViTinh]" +
                " = @Original_DonViTinh)) AND ([DonGia] = @Original_DonGia))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[SanPham] SET [MaSP] = @MaSP, [TenSP] = @TenSP, [DonViTinh] = @DonViTinh, [DonGia] = @DonGia, [Hinh] = @Hinh WHERE (([MaSP] = @Original_MaSP) AND ([TenSP] = @Original_TenSP) AND ((@IsNull_DonViTinh = 1 AND [DonViTinh] IS NULL) OR ([DonViTinh] = @Original_DonViTinh)) AND ([DonGia] = @Original_DonGia));
SELECT MaSP, TenSP, DonViTinh, DonGia, Hinh FROM SanPham WHERE (MaSP = @MaSP)";
        ...
        public virtual int Fill(DataSetCTHD.SanPhamDataTable dataTable) {
        ...
        public virtual DataSetCTHD.SanPhamDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetCTHD.SanPhamDataTable dataTable = new DataSetCTHD.SanPhamDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetCTHD.SanPhamDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetCTHD dataSet) {
        ...
        public virtual int Delete(string Original_MaSP, string Original_TenSP, string Original_DonViTinh, double Original_DonGia) {
        ...
        public virtual int Insert(string MaSP, string TenSP, string DonViTinh, double DonGia, string Hinh) {
            if ((MaSP == null)) {
        ...
        public virtual int Update(string MaSP, string TenSP, string DonViTinh, double DonGia, string Hinh, string Original_MaSP, string Original_TenSP, string Original_DonViTinh, double Original_DonGia) {
            if ((MaSP == null)) {
                throw new global::System.ArgumentNullException("MaSP");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenSP, string DonViTinh, double DonGia, string Hinh, string Original_MaSP, string Original_TenSP, string Original_DonViTinh, double Original_DonGia) {
